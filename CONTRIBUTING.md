...
- Self-approval is acceptable while the cell is single-contributor,
  but the PR workflow still applies — it forces the
  diff-and-description discipline and gives every change a durable
  URL.
